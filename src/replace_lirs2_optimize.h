#ifndef __REPLACE_LIRS2_OPTIMIZE_H__
#define __REPLACE_LIRS2_OPTIMIZE_H__

#include "replace_lirs_base.h"

namespace replace {

class LIRS2_Optimize_Replace : public LIRS_Replace {
public:
    LIRS2_Optimize_Replace (TraceHandle* th, uint32_t mem_size);
