...
LIRS2_Optimize_Replace::LIRS2_Optimize_Replace (TraceHandle* th, uint32_t mem_size) {
    mTraceHandle = th;
...
void LIRS2_Optimize_Replace::recordEvict (uint32_t page_num) { evict_list.push_back (page_num); }

/* Remove block from Stack Q */
bool LIRS2_Optimize_Replace::removeHIRList (page_struct* HIR_block_ptr) {
...
page_struct* LIRS2_Optimize_Replace::findLastLirLru (uint32_t which_instance) {
...
bool LIRS2_Optimize_Replace::removeLIRSList (page_struct* page_ptr) {
    assert (page_ptr);
...
// Add node to stack S
void LIRS2_Optimize_Replace::addLruListHead (page_struct* new_ref_ptr) {
    assert (new_ref_ptr);
...
void LIRS2_Optimize_Replace::addHirlistHead (page_struct* new_rsd_HIR_ptr) {
 ...
 */
page_struct* LIRS2_Optimize_Replace::pruneLIRSstack () {
    page_struct* tmp_ptr;
...
void LIRS2_Optimize_Replace::insertLRUList (page_struct* old_ref_ptr, page_struct* new_ref_ptr) {
...
page_struct* LIRS2_Optimize_Replace::findInstanceInQ (uint32_t block_number) {
...
page_struct* LIRS2_Optimize_Replace::pointerInstance (uint32_t block_number,
...
void LIRS2_Optimize_Replace::Report () { Replace::Report (); }

void LIRS2_Optimize_Replace::Run () {
